...
void hal_loop_note(double work_s, bool busy); /* perf: one UI loop's bz_ui_frame time */
void hal_loop_prof(double out[4]); /* perf: busy loops, their mean and max work (s), loops idle */
